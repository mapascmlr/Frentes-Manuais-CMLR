...
lyr_CMLRFrentesManuais_6.set('fieldAliases', {'RH': 'RH', 'Município': 'Município', 'Corpo Híd': 'Corpo Híd', 'Empresa': 'Empresa', 'Classifica': 'Classifica', 'Início': 'Início', 'Status': 'Status', 'Término': 'Término', 'Antes': 'Antes', 'Durante': 'Durante', 'Depois': 'Depois', 'Coordena Y': 'Coordena Y', 'Coordena X': 'Coordena X', });
...
lyr_CMLRFrentesManuais_6.set('fieldImages', {'RH': 'TextEdit', 'Município': 'TextEdit', 'Corpo Híd': '', 'Empresa': 'TextEdit', 'Classifica': '', 'Início': 'TextEdit', 'Status': 'TextEdit', 'Término': 'TextEdit', 'Antes': 'TextEdit', 'Durante': 'TextEdit', 'Depois': 'TextEdit', 'Coordena Y': 'TextEdit', 'Coordena X': 'TextEdit', });
...
lyr_CMLRFrentesManuais_6.set('fieldLabels', {'RH': 'inline label - visible with data', 'Município': 'inline label - visible with data', 'Corpo Híd': 'inline label - visible with data', 'Empresa': 'inline label - visible with data', 'Classifica': 'inline label - visible with data', 'Início': 'inline label - visible with data', 'Status': 'inline label - visible with data', 'Término': 'inline label - visible with data', 'Antes': 'inline label - visible with data', 'Durante': 'inline label - visible with data', 'Depois': 'inline label - visible with data', 'Coordena Y': 'inline label - visible with data', 'Coordena X': 'inline label - visible with data', });
