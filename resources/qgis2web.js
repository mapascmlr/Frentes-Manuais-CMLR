...
map.getView().fit([-5062711.077193, -2684597.772862, -4493762.355310, -2355911.942797], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">CMLR - Frentes Manuais</h2>';
        return titleElement;
    })(),
